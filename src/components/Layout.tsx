  ...
  const items: CardNavItem[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Crime Map', href: '#/map', ariaLabel: 'Open India crime map' },
        { label: 'Compare', href: '#/compare', ariaLabel: 'Compare regions' },
      ],
    },
    {
      label: 'Regions',
      ...
      textColor: '#f8fafc',
      links: [
        { label: 'Delhi', href: '#/region/delhi', ariaLabel: 'View Delhi region details' },
        { label: 'Mumbai', href: '#/region/mumbai', ariaLabel: 'View Mumbai region details' },
        { label: 'Bengaluru', href: '#/region/bengaluru', ariaLabel: 'View Bengaluru region details' },
      ],
    },
  ];
