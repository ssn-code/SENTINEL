...
import { ChevronLeft, Shield, AlertTriangle, TrendingUp, Activity, Info, MapPin } from 'lucide-react';
import { CRIME_DATA } from '../data';
...
export const RegionDetail: React.FC<RegionDetailProps> = ({ regionId }) => {
  const region = useMemo(() => CRIME_DATA.find(r => r.id === regionId), [regionId]);
