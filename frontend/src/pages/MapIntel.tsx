  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 pb-20 pt-32">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <button
              ...
              className="rounded-lg border border-surface px-3 py-2 text-xs text-white hover:bg-white/10 transition"
      ...
      <section className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        <div className="rounded-[2rem] cursor-target border border-white/8 bg-[linear-gradient(180deg,rgba(10,18,28,0.98),rgba(7,12,18,0.98))] p-4 shadow-[0_30px_80px_rgba(0,0,0,0.35)] md:p-6">
          <IndiaCrimeMap
